                    ...
                    <Row>
                        <Col md={6} className='text-center text-md-left p-md-5 p-2'>
                            <Col className='text-left' md={9}>
                                <Image src='/assets/footer/fuzhio_logo.png' alt='' width="80%" />
                                <div className='py-3 '>
                                ...
                                <div className='pt-3 d-flex flex-row'>
                                    <div className='p-2'>
                                        <a href="https://www.linkedin.com/company/fuzhio-health-and-business-services-private-limited" target='_blank'>
                                            <Image src='/linked.svg' alt='' fluid width={25} />
                                        </a>
                                    </div>
                                    <div className='p-2'>
                                        <a href="https://www.facebook.com/fuzhioagri/" target='_blankl'>
